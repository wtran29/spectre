...
func setupApp() (*string, error) {
	...
	identifier := flag.String("identifier", "spectre", "unique identifier")
	...
	databaseName := flag.String("db", "spectre", "database name")
	...
	preferenceMap["version"] = spectreVersion
